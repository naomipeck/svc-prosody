...
```{r, echo=FALSE}
gloss_example(transliteration = "ó ro dittii",
...
```{r, echo=FALSE}
gloss_example(transliteration = "noʔa-k aɓal am-e",
...
```{r, echo=FALSE}
gloss_example(transliteration = "ápwǒoot ̪ ɔ́ ɲɪ ̄ ɟɪ̀ɪw ɲɪ ̄ mīi ʊ́kwɛ́r á-weekɪ ̀ ɲɪ ́ kāaaŋɔ̄ ɛ́ cʊ̂́ʊʊl ̄ a pʌ̀ ʌʌr",
...
```{r, echo=FALSE}
gloss_example(transliteration = "ábác cấm̄ kwʌ̄ n ɛ́ ʊ́-cùŋɔ",
