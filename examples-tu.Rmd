...
```{r, echo=FALSE}
gloss_example(transliteration = "tí kò kama-nà k~ù~ù",
...
```{r, echo=FALSE}
gloss_example(transliteration = "?abá='m kòrè g||óé=sì xàè kyeé.kyeè kùè ?é.sérà ny~ú~u-a k'uì=xù.",
             glosses = "dog=SG.MASC:I CONJ tortoise=SG.FEM:I CONJ listen IPFV 3DU.FEM sit-LK talk=NMLZ",
